  ...
  "externalId": "675792************"
        ...
        <FAQItem question={<Translate id="homepage.faq.q2.title">Como fazer um saque de moeda fiduciária?</Translate>}>
          ...
          <Step number="1" title={<Translate id="homepage.faq.q2.step1.title">Autenticação</Translate>}>
            <p>
              <Translate id="homepage.faq.q2.step1.desc">Realize o login para obter seu token de acesso. Ele é obrigatório no Header para gerar o saque.</Translate>
            </p>
          </Step>

          <Step number="2" title={<Translate id="homepage.faq.q2.step2.title">Buscar Moedas para Saque</Translate>}>
            <p>
              <Translate id="homepage.faq.q2.step2.desc">Consulte as moedas habilitadas para a sua conta através da rota</Translate> <code>[GET] /withdraw/company/currencies</code>.
            </p>
          </Step>

          <Step number="3" title={<Translate id="homepage.faq.q2.step3.title">Criar a solicitação de saque</Translate>}>
            <p>
              <Translate id="homepage.faq.q2.step3.desc">Envie os dados para a rota</Translate> <code>[POST] /withdraw</code> <Translate id="homepage.faq.q2.step3.desc2">informando o valor, customerId, os dados da moeda e a chave Pix no objeto</Translate> pixKey.
            </p>
            <CodeBlock language="json">{`{
  "amount": 1,
  "customerId": "67594a***************",
  ...
  "externalId": "67339fa***************"
        ...
        <FAQItem question={<Translate id="homepage.faq.q3.title">Como fazer um depósito de criptomoeda?</Translate>}>
          ...
          <Step number="2" title={<Translate id="homepage.faq.q3.step2.title">Buscar PublicKey da Carteira</Translate>}>
            <p><Translate id="homepage.faq.q3.step2.desc">Solicite as chaves públicas (wallets) vinculadas ao cliente em</Translate> <code>[GET] /crypto/customer/CLIENT_ID/wallet</code>.</p>
            <CodeBlock language="json">{`[
  {
    "blockchainNetworks": [
      "Ethereum",
