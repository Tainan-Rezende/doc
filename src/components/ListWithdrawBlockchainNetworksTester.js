...
export default function ListBlockchainNetworksTester() {
  const { i18n: { currentLocale } } = useDocusaurusContext();

  const i18n = {
    'pt-br': {
      title: 'Testar: Listar Redes Blockchain',
      step1: '1. Suas Credenciais',
      emailLabel: 'Email',
      emailPlaceholder: 'email@...',
      pwdLabel: 'Senha',
      btnExecute: 'Listar Redes Disponíveis',
    ...
    en: {
      title: 'Test: List Blockchain Networks',
      step1: '1. Your Credentials',
      emailLabel: 'Email',
      emailPlaceholder: 'email@...',
      pwdLabel: 'Password',
      btnExecute: 'List Available Networks',
      btnLoading: 'Loading...',
      status: 'Status',
      statusFail: 'Failed',
    ...
    es: {
      title: 'Probar: Listar Redes Blockchain',
      step1: '1. Sus Credenciales',
      emailLabel: 'Correo electrónico',
      emailPlaceholder: 'correo@...',
      pwdLabel: 'Contraseña',
      btnExecute: 'Listar Redes Disponibles',
      btnLoading: 'Cargando...',
      status: 'Estado',
      statusFail: 'Fallo',
  ...
  const handleList = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${baseUrl}/withdraw/company/blockchain-networks`, {
        method: 'GET',
        headers: {
