  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '15px', borderBottom: '1px solid var(--ifm-color-emphasis-200)', paddingBottom: '10px' }}>
        ...
        <h3 style={{ margin: 0, fontSize: '1.1rem' }}>Testar Integração Completa</h3>
      </div>

      <p style={{ fontSize: '0.9rem', marginBottom: '15px', color: 'var(--ifm-color-emphasis-700)' }}>
        Insira suas credenciais e o ID do cliente. O sistema fará o login e buscará as chaves automaticamente.
      </p>
      ...
      <form onSubmit={handleFullTest}>
        ...
        <div>
          ...
          <div style={{ marginBottom: '15px' }}>
            Não possui cliente? Clique aqui para criar.
          </div>
        </div>
