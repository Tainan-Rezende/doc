...
export default function ListDepositCryptoCurrenciesTester() {
  const { i18n: { currentLocale } } = useDocusaurusContext();

  const i18n = {
    'pt-br': {
      title: 'Testar: Listar Criptomoedas de Depósito',
    ...
    en: {
      title: 'Test: List Deposit Cryptocurrencies',
    ...
    es: {
      title: 'Probar: Listar Criptomonedas de Depósito',
  ...
  const handleList = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${baseUrl}/deposit/company/cryptocurrencies`, {
        method: 'GET',
        headers: {
